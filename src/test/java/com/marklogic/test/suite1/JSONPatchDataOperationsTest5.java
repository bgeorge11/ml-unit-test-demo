...
public class JSONPatchDataOperationsTest5 extends AbstractApiTest {
	...
	public void loadAndPatchJSONDocuments(DatabaseClient client, String COLLECTION_NAME) throws Exception {
		...
		for (int i = 0; i < lstFiles.size(); i++) {
            ...
            /* Can also use writeHandle to add the nodes
            pb.insertFragment("/object-node()", DocumentPatchBuilder.Position.LAST_CHILD, writeHandle);
            */
	...
	public void testLoadJSONDocuments() throws Exception {
		...
		String methodName = new JSONPatchDataOperationsTest5() {
