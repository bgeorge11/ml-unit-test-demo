...
public class XMLDataOperationsTest3 extends AbstractApiTest {
	...
	public void loadXMLDocuments(DatabaseClient client, String COLLECTION_NAME) throws Exception {
		...
		for (int i = 0; i < lstFiles.size(); i++) {
			...
			metadata.withMetadataValue("MyKey", "MyValue");
			metadata.withProperty("MyKey1", "MyValue1");
			metadata.withCollections(COLLECTION_NAME);
	...
	public void testLoadXMLDocuments() throws Exception {
		...
		String methodName = new XMLDataOperationsTest3() {
